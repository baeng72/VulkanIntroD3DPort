...
layout (set=3,binding=0) uniform sampler2DArray textureMap;
...
void main(){
	vec4 diffuseAlbedo = texture(textureMap,vec3(inTexC,gl_PrimitiveID%3)) * gDiffuseAlbedo;
    ...
    vec4 directLight = ComputeLighting( mat, inPosW, 
