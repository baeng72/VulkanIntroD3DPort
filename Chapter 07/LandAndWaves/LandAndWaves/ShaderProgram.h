...
enum ShaderResourceType { prtBuffer, prtTexture };
struct ShaderResource :public DescriptorInfo {
	...
	ShaderResource(VkDescriptorType descriptorType_, VkShaderStageFlags shaderStage_, size_t width_, size_t height_, uint8_t* pixels_);/* {
		descriptorType = descriptorType_;
		shaderStage = shaderStage_;
		type = prtTexture;
