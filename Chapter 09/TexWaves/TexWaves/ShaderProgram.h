...
struct ShaderResource :public DescriptorInfo {
	...
	ShaderResource(VkDescriptorType descriptorType_, VkShaderStageFlags shaderStage_, size_t size_, size_t count_, bool isMapped_);/* {
...
class ShaderResources {
	...
	void AddBuffer(ShaderResource& res, uint32_t passCount, ShaderResInternal& pipeRes); //{
//		Vulkan::Buffer buffer;
