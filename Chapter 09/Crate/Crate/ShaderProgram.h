...
struct ShaderResource :public DescriptorInfo {
	...
	ShaderResource(VkDescriptorType descriptorType_, VkShaderStageFlags, Vulkan::Texture& texture);
};
...
struct ShaderResInternal {
	...
	ShaderResInternal(VkDescriptorType descriptorType_, Vulkan::Texture& texture_) {
		descriptorType = descriptorType_;
		texture = texture_;
	}
};
